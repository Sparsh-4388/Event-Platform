      ...
      <footer className="footer-simple">
        ...
        <div className="footer-content">
          ...
          <div className="footer-socials">
            <a href="https://github.com/Sparsh-4388" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/sparsh-pal-7a9684242/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
